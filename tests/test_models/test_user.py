...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_for_email_is_public_str(self):
        self.assertEqual(str, type(User.email))

    def test_for_password_is_public_str(self):
        self.assertEqual(str, type(User.password))

    def test_for_first_name_is_public_str(self):
        self.assertEqual(str, type(User.first_name))

    def test_for_last_name_is_public_str(self):
        self.assertEqual(str, type(User.last_name))

    def test_for_two_users_unique_ids(self):
        us1 = User()
        us2 = User()
